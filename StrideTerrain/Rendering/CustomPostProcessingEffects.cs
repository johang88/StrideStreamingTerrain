...
{
    public static CustomPostProcessingEffects? Current { get; private set; } // TODO: yes yes ...
    ...
    protected override void DrawCore(RenderDrawContext context)
    {
        ...
        if (ExposureSettings.AutoExposure)
        {
            ...
            _histogramReduceShader.Parameters.Set(HistogramReduceKeys.AutoKeyBiasPower, ExposureSettings.AutoKeyBiasPower);

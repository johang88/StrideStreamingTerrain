...
{
    public static partial class AtmosphereRenderAerialPerspectiveKeys
    {
        ...
        public static readonly ObjectParameterKey<Texture> Depth = ParameterKeys.NewObject<Texture>();

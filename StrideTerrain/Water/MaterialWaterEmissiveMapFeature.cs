...
using StrideTerrain.Water.Effects;
using System;
...
public class MaterialWaterEmissiveMapFeature : MaterialFeature, IMaterialEmissiveFeature
{
    ...
    [DataMember(60), Display(name: "Texture", category: "Normal Map")] public Texture? NormalMap { get; set; }
    [DataMember(61), Display(name: "Speed", category: "Normal Map")] public Vector2 Speed { get; set; } = new Vector2(0.02f, 0.02f);
